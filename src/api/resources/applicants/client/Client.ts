...
export class Client {
    ...
    public async getAll(request?: PropifyApi.GetAllApplicationsRequest): Promise<PropifyApi.GetAllApplicantsResponse> {
        ...
        const _response = await core.fetcher({
            url: urlJoin(this.options.environment ?? environments.PropifyApiEnvironment.Demo, "/v1/applicants"),
            method: "GET",
            headers: {
    ...
    public async get(
        ...
        const _response = await core.fetcher({
            url: urlJoin(this.options.environment ?? environments.PropifyApiEnvironment.Demo, `/v1/applicants/${id}`),
            method: "GET",
            headers: {
                "propify-api-key": this.options.propifyApiKey,
                "propify-api-secret": await core.Supplier.get(this.options.propifyApiSecret),
