...
export class Client {
     ...
     */
    public async getAllUnits(request?: PropifyApi.GetAllUnitsRequest): Promise<PropifyApi.AllUnits> {
        ...
        const _response = await core.fetcher({
            url: urlJoin(this.options.environment, "/v1/units/"),
            method: "GET",
            headers: {
        ...
        if (_response.ok) {
            return await serializers.units.getAllUnits.Response.parse(
                _response.body as serializers.units.getAllUnits.Response.Raw
            );
        }
