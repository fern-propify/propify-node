...
export class Client {
     ...
     */
    public async getAllVendors(): Promise<PropifyApi.AllVendors> {
        const _response = await core.fetcher({
            url: urlJoin(this.options.environment, "/v1/vendors/"),
            method: "GET",
            headers: {
        ...
        if (_response.ok) {
            return await serializers.vendors.getAllVendors.Response.parse(
                _response.body as serializers.vendors.getAllVendors.Response.Raw
            );
        }
