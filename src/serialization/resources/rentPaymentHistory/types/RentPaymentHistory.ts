...
export const RentPaymentHistory: core.serialization.ObjectSchema<
    serializers.RentPaymentHistory.Raw,
    PropifyApi.RentPaymentHistory
...
export declare namespace RentPaymentHistory {
    interface Raw {
        id: string;
        created_at: string;
        updated_at: string;
